    ...
    children: [
        ...
        children: [
          {
            ...
            component: () => import('~~/pages/demos/access/index.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () => import('~~/pages/demos/access/button-control.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () =>
              import('~~/pages/demos/access/menu-visible-403.vue'),
            meta: {
              authority: ['no-body'],
              icon: 'mdi:button-cursor',
          ...
          },
          {
            ...
            component: () => import('~~/pages/demos/access/super-visible.vue'),
            meta: {
              authority: ['super'],
              icon: 'mdi:button-cursor',
          ...
          },
          {
            ...
            component: () => import('~~/pages/demos/access/admin-visible.vue'),
            meta: {
              authority: ['admin'],
              icon: 'mdi:button-cursor',
          ...
          },
          {
            ...
            component: () => import('~~/pages/demos/access/user-visible.vue'),
            meta: {
              authority: ['user'],
              icon: 'mdi:button-cursor',
        ...
        children: [
          {
            ...
            component: () =>
              import('~~/pages/demos/features/login-expired/index.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () => import('~~/pages/demos/features/icons/index.vue'),
            meta: {
              icon: 'lucide:annoyed',
          ...
          },
          {
            ...
            component: () =>
              import('~~/pages/demos/features/watermark/index.vue'),
            meta: {
              icon: 'lucide:tags',
          ...
          },
          {
            ...
            component: () => import('~~/pages/demos/features/tabs/index.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () =>
              import('~~/pages/demos/features/tabs/tab-detail.vue'),
            meta: {
            ...
            children: [
              {
                ...
                component: () =>
                  import(
                    '~~/pages/demos/features/hide-menu-children/parent.vue'
                  ),
                meta: {
                  // hideInMenu: true,
                  title: $t('demos.features.hideChildrenInMenu'),
              ...
              },
              {
                ...
                component: () =>
                  import(
                    '~~/pages/demos/features/hide-menu-children/children.vue'
                  ),
                meta: {
          ...
          },
          {
            ...
            component: () =>
              import('~~/pages/demos/features/full-screen/index.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () =>
              import('~~/pages/demos/features/file-download/index.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () =>
              import('~~/pages/demos/features/clipboard/index.vue'),
            meta: {
              icon: 'lucide:copy',
          ...
          },
          {
            ...
            component: () =>
              import('~~/pages/demos/features/menu-query/index.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () =>
              import('~~/pages/demos/features/new-window/index.vue'),
            meta: {
              icon: 'lucide:app-window',
          ...
          },
          {
            ...
            component: () =>
              import('~~/pages/demos/features/vue-query/index.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () =>
              import(
                '~~/pages/demos/features/request-params-serializer/index.vue'
              ),
            meta: {
              icon: 'lucide:git-pull-request-arrow',
          ...
          },
          {
            ...
            component: () =>
              import('~~/pages/demos/features/json-bigint/index.vue'),
            meta: {
              icon: 'lucide:grape',
              title: 'JSON BigInt',
            },
        ...
        children: [
          {
            ...
            component: () => import('~~/pages/demos/breadcrumb/lateral.vue'),
            meta: {
              icon: 'lucide:navigation',
          ...
          },
          {
            ...
            component: () =>
              import('~~/pages/demos/breadcrumb/lateral-detail.vue'),
            meta: {
            ...
            children: [
              {
                ...
                component: () =>
                  import('~~/pages/demos/breadcrumb/level-detail.vue'),
                meta: {
        ...
        children: [
          {
            ...
            component: () => import('~~/pages/_core/fallback/forbidden.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () =>
              import('~~/pages/_core/fallback/internal-error.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () => import('~~/pages/_core/fallback/offline.vue'),
            meta: {
              icon: 'mdi:offline',
      ...
      // 菜单徽标
      {
        ...
        children: [
          {
            name: 'BadgeDotDemo',
            component: () => import('~~/pages/demos/badge/index.vue'),
      ...
      // 菜单激活图标
      {
        ...
        children: [
          {
            name: 'ActiveIconDemo',
            component: () => import('~~/pages/demos/active-icon/index.vue'),
        ...
        children: [
          {
            ...
            component: () => import('~~/pages/demos/nested/menu-1.vue'),
            meta: {
              icon: 'ic:round-menu',
              keepAlive: true,
            ...
            children: [
              {
                ...
                component: () => import('~~/pages/demos/nested/menu-2-1.vue'),
                meta: {
                  icon: 'ic:round-menu',
                  keepAlive: true,
            ...
            children: [
              {
                ...
                component: () => import('~~/pages/demos/nested/menu-3-1.vue'),
                meta: {
                  icon: 'ic:round-menu',
                  keepAlive: true,
                ...
                children: [
                  {
                    ...
                    component: () =>
                      import('~~/pages/demos/nested/menu-3-2-1.vue'),
                    meta: {
                      icon: 'ic:round-menu',
                      keepAlive: true,
