...
const routes: Array<RouteRecordRaw> = [
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            component: () =>
              import('~~/pages/examples/captcha/slider-captcha.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () =>
              import('~~/pages/examples/captcha/slider-rotate-captcha.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () =>
              import('~~/pages/examples/captcha/slider-translate-captcha.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () =>
              import('~~/pages/examples/captcha/point-selection-captcha.vue'),
            meta: {
      ...
      },
      {
        name: 'ModalExample',
        path: '/examples/modal',
        component: () => import('~~/pages/examples/modal/index.vue'),
        meta: {
      ...
      },
      {
        ...
        component: () => import('~~/pages/examples/drawer/index.vue'),
        meta: {
          icon: 'iconoir:drawer',
          keepAlive: true,
      ...
      },
      {
        ...
        component: () => import('~~/pages/examples/ellipsis/index.vue'),
        meta: {
      ...
      },
      {
        ...
        component: () => import('~~/pages/examples/resize/basic.vue'),
        meta: {
      ...
      },
      {
        name: 'TippyDemo',
        path: '/examples/tippy',
        component: () => import('~~/pages/examples/tippy/index.vue'),
        meta: {
      ...
      },
      {
        ...
        component: () => import('~~/pages/examples/json-viewer/index.vue'),
        meta: {
          icon: 'tabler:json',
          title: 'JsonViewer',
        },
      },
      {
        ...
        component: () => import('~~/pages/examples/motion/index.vue'),
        meta: {
      ...
      },
      {
        ...
        component: () => import('~~/pages/examples/count-to/index.vue'),
        meta: {
          icon: 'mdi:animation-play',
          title: 'CountTo',
        },
      },
      {
        ...
        component: () => import('~~/pages/examples/loading/index.vue'),
        meta: {
      ...
      },
      {
        ...
        component: () => import('~~/pages/examples/button-group/index.vue'),
        meta: {
