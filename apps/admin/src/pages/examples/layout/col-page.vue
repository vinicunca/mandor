...
<template>
  ...
  >
    <template #title>
      <span class="text-2xl font-bold mr-2">ColPage 双列布局组件</span>
    ...
    <template #left="{ isCollapsed, expand }">
      ...
      <div
        ...
        class="mr-2 p-2 border border-border rounded-[var(--radius)] bg-card"
      >
        <p>这里是左侧内容</p>
        <p>这里是左侧内容</p>
        <p>这里是左侧内容</p>
    ...
    >
      <div class="flex flex-col gap-2">
        <div class="flex gap-2">
          <Checkbox v-model:checked="props.resizable">
            可拖动调整宽度
          </Checkbox>
          <Checkbox v-model:checked="props.splitLine">
            显示拖动分隔线
          </Checkbox>
          <Checkbox v-model:checked="props.splitHandle">
            显示拖动手柄
          </Checkbox>
